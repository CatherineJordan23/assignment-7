...
let favoriteFoods = ["Fries", "Chicken", "Rice", "Tacos", "Burritos", "Burgers"];
...
printFoodRecommendation("Fries");
printFoodRecommendation("Burgers");
printFoodRecommendation("Burritos");
...
console.log("The longest food name in the list is " + 
  longestFood + " with " + longestFood.length + " characters."
);